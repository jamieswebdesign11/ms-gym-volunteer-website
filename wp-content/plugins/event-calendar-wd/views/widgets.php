...
class ECWD_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                false, $name = __('Event Calendar WD', 'event-calendar-wd'), array('description' => __('A calendar of your events', 'event-calendar-wd'))
        );
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        if($instance['theme'] !== 'calendar_theme'){
            ECWD_Cpt::generate_theme_file($instance['id'],$instance['theme'],'ecwd_calendar');
        }
    ...
    function form($instance) {
        ...
        <p>
          ...
          <select id="<?php echo $this->get_field_id('theme'); ?>" name="<?php echo $this->get_field_name('theme'); ?>"
                  class="widefat">
            <option value="calendar_theme" <?php selected($selected_theme, "calendar_theme"); ?>><?php _e('Calendar theme', 'event-calendar-wd'); ?></option>
            <?php foreach ($themes as $theme) { ?>
              <option
                value="<?php echo $theme->ID; ?>" <?php selected($selected_theme, $theme->ID); ?>>
