        ...
        <td>
            <div class="<?php echo ECWD_PLUGIN_PREFIX; ?>_repeat">
                ...
                <div class="<?php echo ECWD_PLUGIN_PREFIX; ?>_repeat_advanced ">
                    ...
                    <div id="ecwd_yearly" class="hidden">
                        <div class="ecwd_event_repeat_event_div">
                            <input type='radio' value="1" <?php checked($single_event->repeat['ecwd_event_repeat_year_on_days'], '1') ?>
                                   ...
                                   class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_choose"/>
                            <label class="repeat_format_monthly"
                                   for="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days_1"><?php _e('On the same day', 'event-calendar-wd'); ?>:</label>
                        </div>
                        ...
                        <div class="ecwd_event_repeat_event_div">
                            ...
                            <select style="margin: 0;" name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_year_month"
                            ...
                            <select style="margin-left: 95px;" name="<?php echo ECWD_PLUGIN_PREFIX; ?>_monthly_list_yearly"
                                    class="select_to_enable_disable">
                    ...
                    <div class="ecwd_exception_date">
                        <label for="ecwd_add_edate">Exception date</label>
                        <button class="button tagadd" id="ecwd_add_edate">Add</button>
                          <div class="ecwd_exception_inputs">
                          <?php if(isset($single_event->exception_date) && is_array($single_event->exception_date)):?>
                                <?php foreach($single_event->exception_date as $edate):?>
                                  <?php if(!empty($edate)):?>
                                    <div class='ecwd_input_block'>
                                        <input class='ecwd_exception_input' type='text' value="<?php echo $edate;?>" name='ecwd_exception_date[]' autocomplete="off">
                                        <span class="delete_exception_input dashicons dashicons-no"></span>
                                    </div>
                                  <?php endif;?>
                              <?php endforeach;?>
                            <?php endif;?>
