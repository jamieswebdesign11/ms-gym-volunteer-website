...
<table class="form-table">
  ...
  <tr class="ecwd_venue_form_field">
    <th><?php _e("Title", "event-calendar-wd")?>:<span style="color:#c60d0d"> *</span></th>
        ...
        <div class="ecwd_google_map_wrapper">
          <div class="ecwd_google_map <?php echo $venue_map_class; ?>">
            ...
            <div class="<?php echo $lat_long_container_class; ?>">
              <label style="width:85px;display:inline-block;" for="ecwd_latitude"><?php _e("Latitude", "event-calendar-wd");?>:</label>
              <input type="text" id="ecwd_latitude" value="<?php echo esc_attr($latitude); ?>"/>
              <br/>
              <label style="width:85px;display:inline-block;" for="ecwd_longitude"><?php _e("Longitude", "event-calendar-wd");?>:</label>
