(function() {
    tinymce.PluginManager.add('ecwd', function( editor_calendar, url ) {
        ...
        editor_calendar.addCommand('ecwd_popup', function(ui, v) {
            ...
            if(typeof ecwd_filters !=='undefined'){
                ...
                filters = {
                    ...
                    items: [
                        {//add id select
                            type: 'listbox',
                            name: 'filters_1',
                            label: ecwd_translate.ecwd_filter_1,
                            value: filters_1,
                        ...
                        {//add id select
                            type: 'listbox',
                            name: 'filters_2',
                            label: ecwd_translate.ecwd_filter_2,
                            value: filters_2,
                            'values': ecwd_filters.filters,
                            tooltip: 'Select filter'
                        },
                        {//add id select
                            type: 'listbox',
                            name: 'filters_3',
                            label: ecwd_translate.ecwd_filter_3,
                            value: filters_3,
                            'values': ecwd_filters.filters,
                            tooltip: 'Select filter'
                        },
                        {//add id select
                            type: 'listbox',
                            name: 'filters_4',
                            label: ecwd_translate.ecwd_filter_4,
                            value: filters_4,
                            'values': ecwd_filters.filters,
                            tooltip: 'Select filter'
                        },
                        {//add id select
                            type: 'listbox',
                            name: 'filters_5',
                            label: ecwd_translate.ecwd_filter_5,
                            value: filters_5,
                            'values': ecwd_filters.filters,
                            tooltip: 'Select filter'
                        }
                ...
                filters =  {
                    ...
                    items: [
                        {//add id select
                            type: 'container',
                            label: ecwd_translate.ecwd_view_activate_filters
            ...
            var displays_6 = '4day';
            if (displays_arr[5])
                displays_6 = displays_arr[5];

            var displays_7 = 'posterboard';
            if (displays_arr[6])
                displays_7 = displays_arr[6];
            ...
            if(ecwd_plugin.ecwd_calendars.length !== 0) {
                ...
                calendars =   {//add id select
                    type: 'container',
                    label: ecwd_translate.ecwd_please_add,
                    styles: 'color:red'
                };
            }
            var content = '';
           ...
           var win = editor_calendar.windowManager.open( {
                ...
                body: [
                    {
                        title: ecwd_translate.ecwd_general,
                        type: "form",
                        layout: 'flex',
                        direction: 'column',
                        align: 'stretch',
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {//add id select
                                type: 'listbox',
                                name: 'displays_5',
                                label: ecwd_translate.ecwd_view_5,
                                value: displays_5,
                                'values': ecwd_plugin.ecwd_views,
                                tooltip: 'Select display mode'
                            },
                            {//add id select
                                type: 'listbox',
                                name: 'displays_6',
                                label: ecwd_translate.ecwd_view_6,
                                value: displays_6,
                                'values': ecwd_plugin.ecwd_views,
                                tooltip: 'Select display mode'
                            },
                            {//add id select
                                type: 'listbox',
                                name: 'displays_7',
                                label: ecwd_translate.ecwd_view_7,
                                value: displays_7,
                                'values': ecwd_plugin.ecwd_views,
                                tooltip: 'Select display mode'
                            }
                ...
                onsubmit: function( e ) { //when the ok button is clicked
                    ...
                    if(typeof data.id!= 'undefined' && data.id.length) {
                        ...
                        if (typeof data.displays_5 != 'undefined' && data.displays_5.length) {
                            shortcode_str += data.displays_5 + ',';
                        }
                        if (typeof data.displays_6 != 'undefined' && data.displays_6.length) {
                            shortcode_str += data.displays_6 + ',';
                        }
                        if (typeof data.displays_7 != 'undefined' && data.displays_7.length) {
                            shortcode_str += data.displays_7;
                        }
                        shortcode_str += '"';
