...
class ECWDElementor extends \Elementor\Widget_Base {
  ...
  protected function _register_controls() {
    ...
    if ( ECWD_PRO  && $ecwd_filters_active) {
      $filter_options = [
        'none' => __('None', 'ecwd'),
        'days' => __('Days', 'ecwd'),
        'categories' => __('Categories', 'ecwd'),
        'tags' => __('Tags', 'ecwd'),
        'venues' => __('Venues', 'ecwd'),
        'organizers' => __('Organizers', 'ecwd'),
      ];
      ...
      $this->add_control('control_filter_1',
        [
          'label' => __('Filter 1', 'ecwd'),
          'label_block' => FALSE,
          'show_label' => TRUE,
          'type' => \Elementor\Controls_Manager::SELECT,
      ...
      $this->add_control('control_filter_2',
        [
          'label' => __('Filter 2', 'ecwd'),
          'label_block' => FALSE,
          'show_label' => TRUE,
          'type' => \Elementor\Controls_Manager::SELECT,
          'options' => $filter_options,
      ...
      $this->add_control('control_filter_3',
        [
          'label' => __('Filter 3', 'ecwd'),
          'label_block' => FALSE,
          'show_label' => TRUE,
          'type' => \Elementor\Controls_Manager::SELECT,
          'options' => $filter_options,
      ...
      $this->add_control('control_filter_4',
        [
          'label' => __('Filter 4', 'ecwd'),
          'label_block' => FALSE,
          'show_label' => TRUE,
          'type' => \Elementor\Controls_Manager::SELECT,
          'options' => $filter_options,
      ...
      $this->add_control('control_filter_5',
        [
          'label' => __('Filter 5', 'ecwd'),
          'label_block' => FALSE,
          'show_label' => TRUE,
          'type' => \Elementor\Controls_Manager::SELECT,
          'options' => $filter_options,
  ...
  protected function render() {
	...
	$filters = "";
  if ( ECWD_PRO && $ecwd_filters_active) {
    $filters .= $settings['control_filter_1'] . ',';
    $filters .= $settings['control_filter_2'] . ',';
    $filters .= $settings['control_filter_3'] . ',';
    $filters .= $settings['control_filter_4'] . ',';
    $filters .= $settings['control_filter_5'];
  }
