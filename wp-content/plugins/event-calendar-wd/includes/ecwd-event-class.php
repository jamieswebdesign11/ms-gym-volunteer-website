...
class ECWD_Event {
     ...
     *
     */
    public function __construct($id, $calendar_id, $title, $description, $location, $start_time, $end_time, $url, $latLong = '', $permalink = '', $event = '', $term_metas = '', $metas = '', $image = '',$other=array()) {
        $this->event_id = $id;
        $this->calendar_id = $calendar_id;
        $this->title = $title;
        $this->description = $description; /*Remove do_shortcode, description is used in unused get_event_markup() function*/
        ...
        $this->metas = $metas;
        $this->image = $image;
        $this->venue = (isset($other['venue'])) ? $other['venue'] : "";
        $this->organizer = (isset($other['organizer'])) ? $other['organizer'] : "";
    }
    ...
    public function get_event_markup($display_type, $num_in_day, $num) {
        ...
        if (!empty($display_options['display_link'])) {
            ...
            $markup .= '<p class="ecwd-' . $this->type . '-link"><a href="' . esc_url($link) . '" ' . $target . '>' . esc_html($display_options['display_link_text']) . '</a></p>';
        }
