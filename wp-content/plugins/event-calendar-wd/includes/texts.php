...
__('Jan', 'event-calendar-wd');
__('Feb', 'event-calendar-wd');
__('Mar', 'event-calendar-wd');
__('Apr', 'event-calendar-wd');
__('May', 'event-calendar-wd');
__('Jun', 'event-calendar-wd');
__('Jul', 'event-calendar-wd');
__('Aug', 'event-calendar-wd');
__('Sep', 'event-calendar-wd');
__('Oct', 'event-calendar-wd');
__('Nov', 'event-calendar-wd');
__('Dec', 'event-calendar-wd');

__('Back','event-calendar-wd');

__('Publish','event-calendar-wd');
__('Draft','event-calendar-wd');
__('Pending','event-calendar-wd');